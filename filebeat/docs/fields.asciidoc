...
Fields exported by the zabbix module
...
Fields exported by the Zabbix history fileset
...
Host name of the item host.



*`zabbix.history.host.host`*::
+
--
Host name.
...
*`zabbix.history.host.host.keyword`*::
+
--
type: keyword
...
*`zabbix.history.host.name.keyword`*::
+
--
type: keyword
...
*`zabbix.history.applications`*::
+
--
List of the item applications; empty if there are none.
...
*`zabbix.history.applications.keyword`*::
+
--
type: keyword
...
+
--
Number of seconds since Epoch to the moment when value was collected (integer part).
...
+
--
Number of nanoseconds to be added to clock to get a precise value collection time.
...
*`zabbix.history.timestamp`*::
+
--
Log only. 0 if not available.
...
*`zabbix.history.source`*::
+
--
Log only. Empty string if not available.
...
Fields exported by the Zabbix problems fileset



*`zabbix.problems.hosts`*::
+
--
List of hosts involved in the trigger expression; there should be at least one element in array.
...
*`zabbix.problems.hosts.host.keyword`*::
+
--
type: keyword
...
*`zabbix.problems.hosts.name.keyword`*::
+
--
type: keyword
...
*`zabbix.problems.groups.keyword`*::
+
--
type: keyword
...
*`zabbix.problems.tags`*::
+
--
List of problem tags (can be empty).
...
*`zabbix.problems.tags.tag.keyword`*::
+
--
type: keyword
...
*`zabbix.problems.tags.value`*::
+
--
Tag value (can be empty).
...
*`zabbix.problems.tags.value.keyword`*::
+
--
type: keyword
...
*`zabbix.problems.clock`*::
+
--
Number of seconds since Epoch to the moment when problem was detected (integer part).
...
+
--
Number of nanoseconds to be added to clock to get a precise problem detection time.
...
*`zabbix.problems.eventid`*::
+
--
Problem or recovery event ID.
...
*`zabbix.problems.p_eventid`*::
+
--
If this is a recovery event then this is the problem event ID.
...
*`zabbix.problems.value`*::
+
--
1 if this is a problem event, 0 if this is a recovery event.
...
Fields exported by the Zabbix trends fileset
...
*`zabbix.trends.host.host.keyword`*::
+
--
type: keyword
...
*`zabbix.trends.host.name.keyword`*::
+
--
type: keyword
...
*`zabbix.trends.applications.keyword`*::
+
--
type: keyword
...
+
--
Number of values collected for a given hour.
...
+
--
Minimum item value for a given hour.
...
+
--
Average item value for a given hour.
...
+
--
Maximum item value for a given hour.
